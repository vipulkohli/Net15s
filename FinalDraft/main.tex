...
\begin{abstract}
Exploring and understanding the topology of a computer network provides the researcher with valuable insight into the distribution of traffic, properties of central nodes, and the hierarchical structure of the network. Using this insight, researchers can take steps to improve the overall network performance by developing more efficient algorithms or equipping highly-utilized nodes with upgraded technology. The purpose of this article is to represent the connectivity and physical media used throughout the Internet with a graph-based model as well as to explore the topology of international networks. This purpose is achieved through research and experimentation into Internet Service Provider (ISP) network maps, country demographics, and software tools for tracking packets through the Internet. Additionally, this paper explores the effects that network politics and privacy to the global Internet connectivity could potentially have on the routing patterns between the different types of ISP's that service both edge and transit core networks. 
...
% Using traceoute, a tool that allows a user to see the intermediate routers/computers a packet hits on its way to its destination, we can examine how traffic is routed across the Internet. <–– This should be in research methodology, not intro
\end{Introduction}
...
% not sure I understand the following paragraph too well...
